...
| [**Blog + Admin**](bibllo/) | Blog corporativo com destaques, filtro por categoria, busca e paginação — mais o **portal administrativo** para a equipe publicar sozinha (destaque em 1 clique, SEO com prévia do Google, newsletter). | [Abrir demo →](https://eduardoeug.github.io/workana/bibllo/) |
| [**Casamento**](casamento/) | **Plataforma multi-casamento**: cada casal com seu site de destination wedding (programação, hospedagem, transfer, RSVP), painel próprio com confirmações em tempo real, visão da plataforma e o mesmo código virando **app mobile via Capacitor**. | [Abrir demo →](https://eduardoeug.github.io/workana/casamento/) |
| [**Rotina (BuJo)**](bujo/) | App de rotina no método Bullet Journal — registro rápido com os significantes reais, migração de tarefas, logs diário/mensal/futuro, coleções e habit tracker, tudo interativo. | [Abrir demo →](https://eduardoeug.github.io/workana/bujo/) |
| [**Bancadas**](bancadas/) | Catálogo interativo de bancadas modulares — configurador com 8 comprimentos, 3 alturas, 3 profundidades, 3 cores e 5 acessórios, desenho SVG que muda a cada escolha e pedido pelo WhatsApp já preenchido. | [Abrir demo →](https://eduardoeug.github.io/workana/bancadas/) |
...
Projetos em HTML, CSS e JavaScript puro (e React, no caso da Lumo), sem build, publicados com GitHub Pages.
