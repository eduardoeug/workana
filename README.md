...
| [**Casamento**](casamento/) | Destination wedding como produto: site dos convidados (programação, hospedagem, transfer, RSVP), **painel dos noivos** com confirmações em tempo real e o mesmo código virando **app mobile via Capacitor**. | [Abrir demo →](https://eduardoeug.github.io/workana/casamento/) |
